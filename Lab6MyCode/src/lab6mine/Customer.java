...
public class Customer
{
  ...
  public Order addOrder(String aItem, int aQuantity, Account aAccount)
  {
    return new Order(aItem, aQuantity, this, aAccount);
  }
  ...
  public Account addAccount(int aAccountNumber, double aTotalPrice)
  {
    return new Account(aAccountNumber, aTotalPrice, this);
  }
